                    ...
                    <nav className="gc-nav">
                        {token ? (
                            <>
                                ...
                                <Link to="/my-bookings" className="gc-link">
                                    Mes réservations
                                </Link>
                                <Link to="/messages" className="gc-link">
                                    Messages
                                </Link>
                                <Link to="/create-trip" className="gc-link">
                                    Créer un trajet
                                </Link>
                                <Link to="/vehicles" className="gc-link">
                                    Véhicules
                                </Link>
                                {user?.role === "ADMIN" && (
                                    <Link to="/admin" className="gc-link">
                                        Administration
                                    </Link>
                                )}
                                <Link
                            ...
                            <Link to="/login" className="gc-link">
                                Connexion
                            </Link>
                        )}
                    </nav>
